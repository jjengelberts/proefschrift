...
\usepackage{ifthen}
\usepackage[pdftex,bookmarks=true,hidelinks,pdfauthor={Jeroen Engelberts},pdftitle={Analysis Of Chemical Bonding Using Ab Initio Valence Bond Theory},pdfsubject={Valence Bond Theory}]{hyperref}
\usepackage{lettrine}
\usepackage{yfonts}
