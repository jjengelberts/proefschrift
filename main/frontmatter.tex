...
%\title{Analysis Of Chemical Bonding Using The Valence Bond Theory}
...
\begin{center}
\Huge{Analysis Of Chemical Bonding Using The Valence Bond Theory}

\vskip 1em%

\LARGE{Analyse Van Chemische Binding Met Valentiebindingstheorie}
