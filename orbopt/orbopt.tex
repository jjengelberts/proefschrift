...
\end{equation}
With looping through all contributing second order cofactors, equation \ref{ch2.eq.twoelexamp2}, with the equality of second order cofactors to density matrix elements (equation \ref{ch2.eq.cofac2isp2}), becomes:
\begin{equation}
\sum_{\sigma\nu} \left\{ [\chi_i\chi_a|\chi_\sigma\chi_\nu] - [\chi_i\chi_\nu|\chi_\sigma\chi_a] \right\} \cdot P^{(\sigma,\nu)}.
