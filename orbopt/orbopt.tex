...
In the approximate Newton-Raphson technique perturbation theory is used to obtain orbital update coefficients. These coefficients are approximated by the quotient of the first column element and the diagonal element on each row of equation \ref{ch2.eq.hamilt}:
\begin{equation}
...
\begin{table}[htbp]
\caption{The total energy of both butadiene and benzene ($E_{tot}$) is presented. The number of iterations, timing per iteration and speed-up factors (compared to \textit{superci}) are also shown.}
\begin{center}
...
\begin{table}[htbp]
\caption{The total energy of both cyclooctatetraene and pentalene ($E_{tot}$) is presented. The number of iterations, timing per iteration and speed-up factors (compared to \textit{superci}) are also shown.}
\begin{center}
\begin{tabular}{l c c c c c c}
\hline
