...
In Figure \ref{ch3.fig.h2_c} the dissociation path for H$_2$ is shown.
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.47]{dissociation/figures/h2_g.eps}
\end{center}
...
\label{ch3.fig.h2_c}
\end{figure}
The total energy curve ($E_\mathrm{tot}^\mathrm{gas}$) and the energy curves of the covalent ($E_\mathrm{cov}^\mathrm{gas}$) and ionic ($E_\mathrm{ion}^\mathrm{gas}$) structures separately are presented. The total and covalent curves practically coincide over the whole range. This indicates the covalent character of the bond in H$_2$. For the covalent structure the weight is at least 0.8 over the whole dissociation range.
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[scale=0.47]{dissociation/figures/nacl_g.eps}
\end{center}
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[scale=0.47]{dissociation/figures/f2_g.eps}
\end{center}
...
\begin{figure}[hb]
\begin{center}
\includegraphics[scale=0.44]{dissociation/figures/ch3cl_g.eps}
\end{center}
...
\begin{figure}[htp]
\begin{center}
\includegraphics[scale=0.44]{dissociation/figures/c4h9cl_g.eps}
\end{center}
...
\begin{figure}[hbp]
\begin{center}
\includegraphics[scale=0.44]{dissociation/figures/sih3cl_g.eps}
\end{center}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.44]{dissociation/figures/c3h9sicl_g.eps}
\end{center}
