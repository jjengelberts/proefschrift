...
For the examination of the case where an excitation takes place from the doubly occupied orbitals, a two determinant wave function is constructed. This wave function contains $\chi_i \equiv \psi_i$, $\chi_j \equiv \overline{\psi_i}$, $\chi_t$, $\chi_u$, $\chi_v$ and $\chi_x$:
\begin{equation}
\Psi_0 = |\chi_i\chi_j\chi_t\chi_u| + |\chi_i\chi_j\chi_v\chi_x|.
\end{equation}
...
For the last type of excitation, the wave function construc
\begin{equation}
\Psi_0 = |\chi_t\chi_u\chi_v|+|\chi_x\chi_y\chi_z|.
\end{equation}

Overlap in equation \ref{ch2.eq.s03}
