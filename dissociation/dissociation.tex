...
For both the methyl substituted compounds, the lowering in dissociation energy in solution compared to the gas phase is standing out, most remarkable for \textbf{2}. While in the gas phase the dissociation energy of \textbf{4} is higher than for \textbf{3}, in solution the situation is reversed. Since methyl groups have a electron donating character, this makes the bond less polar. Therefore, it is easier for \textbf{2} and \textbf{4} to dissociate than for \textbf{1} and \textbf{3}. The most favorable geometry for both ions (at 10 \AA) in solution is the planar one (Figure \ref{ch3.fig.crossing}(a)).
