...
C(CH$_3$)$_3$Cl (\textbf{2})& --616.215745 & --616.090103 & \textit{--616.169955} & 120.1 & 251.4 \\
...
($E_\mathrm{froz-\textbf{II}}$) at 1.9 \AA\ ($R_{1.9 \text{\AA}}$) and at 10.0 \AA\ ($R_{10.0 \text{\AA}}$),
both in the gas phase and in solution (in $E_\mathrm{h}$).}
\center
\begin{tabular}{|c|cc|cc|}
\hline
&\multicolumn{2}{c|}{$R_{1.9 \text{\AA}}$}&\multicolumn{2}{c|}{$R_{10.0 \text{\AA}}$} \\
...
The frozen orbital set \textbf{I} gives almost the same total energy as the free orbital set for the molecule at 1.9 \AA\ in both the gas phase and in solution ($E_{\mathrm{froz}-\textbf{I}}$=--616.210148 a.u. \textit{vs} $E_\mathrm{free}$=--616.208572 a.u. and $E_{\mathrm{froz}-\textbf{I}}$=--616.215080 a.u. \textit{vs} $E_\mathrm{free}$=--616.213089 a.u., respectively). The difference in total energy between the other frozen orbital set \textbf{II} and the free orbital set is about ten times larger ($E_{\mathrm{froz}-\textbf{II}}$=--616.210148 a.u. \textit{vs} $E_\mathrm{free}$=--616.185782 for the gas phase and $E_{\mathrm{froz}-\textbf{II}}$=--616.213089 a.u \textit{vs} $E_\mathrm{free}$=--616.193609 a.u in solution).
