...
\hline
CH$_3$Cl (\textbf{1})& 260.8 & 255.6 \cite{lauvergnat} & 365.3 \cite{lauvergnat} & 1.894 \\
C(CH$_3$)$_3$Cl (\textbf{2}) & 251.7 & 245.6 \cite{psu}, $\approx$ 234 \cite{song} & 360.7 \cite{psu} & 1.935 \\
SiH$_3$Cl (\textbf{3})& 335.2 & 331.1 \cite{lauvergnat} & 463.2 \cite{lauvergnat} & 2.154 \\
Si(CH$_3$)$_3$Cl (\textbf{4}) & 371.3 & --- & --- & 2.175 \\
\hline
\end{tabular}
