...
\section*{Addendum}
It has been more than ten years ago that this chapter was published as an article in a special issue of Physical Chemistry Chemical Physics. Although being in print longer than the articles presented in Chapters \chhuckel\ and \chinorganic, the latter two are referred to roughly twice as much. Still some work has been going on over the past few years \cite{ac01,ac02,ac03,ac04,ac05,ac06,ac07,ac08}. This article has been referred to in other computational articles; no references could be found in any experimental work. This is probably due to its hypothetical nature.

Rashid \textit{et al.} refer to this work for reference of the resonance energy of pentalene \cite{ac03}. Others have extended the range with molecules containing more benzene rings ($n$ > 5, see Chart 1) \cite{ac04,ac07}. 
